...
<head>
  ...
  $sql = "SELECT * FROM vw_produtos where nm_categoria='vestidos'" or die(mysql_error());
  $qr = mysql_query($sql);
  if (false === $qr) {
    echo mysql_error();
}
...
$sql = "SELECT * FROM vw_produtos where nm_categoria='vestidos' limit $incio, $quantidade_pg";
$qr = mysql_query($sql);
$total_produtos = mysql_num_rows($qr);
?>
                                  ...
                                  <ul class="pagination">
                                    <li>
                                      ...
                                      if($pagina_anterior != 0){ ?>
                                        <a href="vestidos.php?pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
                                    ...
                                    for($i = 1; $i < $num_pagina + 1; $i++){ ?>
                                      <li><a href="vestidos.php?pagina=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                    <?php } ?>
                                    <li>
                                      <?php
                                      if($pagina_posterior <= $num_pagina){ ?>
                                        <a href="vestidos.php?pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
