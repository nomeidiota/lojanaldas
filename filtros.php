   ...
   <div class="row">
    ...
    <table id="cart" class="table table-hover table-condensed">
                  ...
                  <th style="width:10%">Nascimento<th>
    					...
    					<tbody>
    						<tr>
                  <?php $total = "SELECT * from tb_usuario" or die (mysql_error());
                        $query1 = mysql_query($total);
                      ...
                      <?php while($row = mysql_fetch_assoc($query1)){ ?>
    							...
    							<td data-th="Codigo"><?php echo $row['cd_usuario']; ?></td>
    							<td data-th="Nome"><?php echo $row['nome']; ?>
    							</td>
    							<td data-th="sobrenome" class="text-center"><?php echo $row['sobrenome']; ?></td>
    							<td data-th="CPF" class="text-center"><?php echo $row['cpf']; ?></td>
                  <td data-th="Telefone" class="text-center"><?php echo $row['telefone']; ?></td>
                  <td data-th="Nascimento" class="text-center"> <?php echo $row['dataNasc']; ?></td><!-- espaço para texto--></td>
