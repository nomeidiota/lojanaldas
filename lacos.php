...
<head>
  ...
  $sql = "SELECT * FROM vw_produtos where nm_categoria='laços'" or die(mysql_error());
  $qr = mysql_query($sql);
  if (false === $qr) {
    echo mysql_error();
}
...
$sql = "SELECT * FROM vw_produtos where nm_categoria='laços' limit $incio, $quantidade_pg";
$qr = mysql_query($sql);
$total_produtos = mysql_num_rows($qr);
?>
             ...
             <div class="col-md-3">
               ...
               <div class="title-categ">
                ...
                <div class="list-group">
                    ...
                    <a href="laços.php" class="list-group-item"> Vestidos</a>
                                  ...
                                  <ul class="pagination">
                                    <li>
                                      ...
                                      if($pagina_anterior != 0){ ?>
                                        <a href="laços.php?pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
                                    ...
                                    for($i = 1; $i < $num_pagina + 1; $i++){ ?>
                                      <li><a href="laços.php?pagina=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                    <?php } ?>
                                    <li>
                                      <?php
                                      if($pagina_posterior <= $num_pagina){ ?>
                                        <a href="laços.php?pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
