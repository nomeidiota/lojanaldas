    ...
    <div class="row" style="padding-top: 30px;">
                ...
                <div class="form-mobile">
                  ...
                  <form class="form-horizontal" method="POST" action="cadastro_usuario.php" onsubmit="return v_cadastro(this);">
                      ...
                      <!--DADOS PESSOAIS ------------------------------------>
                          ...
                          <legend><h3 class="text-center" style="color:#bb0000; text-transform: uppercase;" >Dados de cadastro</h3></legend>

                      <div class="form-group">
                        <label for="name" class="col-sm-3 control-label">Nome</label>
                        <div class="col-sm-3">
                        <input type="text" name="nome" class="form-control" id="nome"  placeholder="Nome" maxlength="90">
                        </div>
                          <label for="name" class="col-sm-1" >Sobrenome</label>
                          <div class="col-sm-3">
                              <input type="text" name="sobrenome" class="form-control" placeholder="Sobrenome" id="nome" maxlength="90">
                          </div>
                      </div>
                      <!--SEXO-->
                      <div class="form-group">
                      ...
                      <div class="col-sm-3">
                        <input type="radio" name="sexo" id="optionsRadios1" value="fem">
                        Feminino
                        <input type="radio" name="sexo" id="optionsRadios2" value="masc">
                        Masculino
                      </div>
                      </div>
      ...
      <div class="form-group">
       ...
       <div class="form-group">
         ...
         <div class="col-sm-3">
           <input type="text" class="form-control" id="cidade" name="cidade" maxlength="90">
         </div>
         <label for="inputPassword3" class="col-sm-2 control-label">Bairro*</label>
         <div class="col-sm-3">
           <input type="text" class="form-control" id="bairro" name="bairro" maxlength="90">
         </div>
       </div>
       ...
       <div class="col-sm-1">
         <select class="" name="estado" id="uf">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-3 ">
          ...
          <div class="col-sm-8">
           ...
           <div class="form-group">
               <label for="email" class="col-sm-3 control-label">Imagem de perfil* </label>
               <div class="col-sm-4">
           ...
           <div class="form-group">
               <label for="email" class="col-sm-3 control-label">Login de usuario* </label>
               <div class="col-sm-4">
                   <input type="text" class="form-control" name="nick" id="login" maxlength="100">
               </div>
           </div>
          ...
          <input type="checkbox"> Aceito termos e condições
        </div>
           <br><br><br>
        <div class="col-md-6 col-md-offset-3">
         ...
         <div class="col-sm-push-5 col-sm-8">
          <input type="submit" name="enviar" value="Cadastrar" class="initial2 btn btn-default btn-lg" onClick="validarSenha()">
        </div>
      </div>
    </div>
